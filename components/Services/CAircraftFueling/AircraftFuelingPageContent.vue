<template>
  <div class="aircraft-fueling-page">
    <!-- Page Header -->
...
import AircraftFuelingDescription from '~/components/Services/CAircraftFueling/SubAF/AircraftFuelingDescription.vue'
import AircraftFuelingImage from '~/components/Services/CAircraftFueling/SubAF/AircraftFuelingImage.vue'
...
export default {
  ...
  data: () => ({
    sections: [
      ...
      { id: 4, label: 'Aircraft Fueling', active: true },
