<template>
  <div class="ground-handling-page">
    <!-- Page Header -->
...
import GroundHandlingDescription from '~/components/Services/AGroundHandling/SubAG/GroundHandlingDescription.vue'
import GroundHandlingImage from '~/components/Services/AGroundHandling/SubAG/GroundHandlingImage.vue'
...
export default {
  ...
  data: () => ({
    sections: [
      ...
      { id: 2, label: 'Ground Handling', active: true },
